...
using Template1.Template2.Repository;
...
namespace Template1.Template2.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Filters.Add(new Template1.Template2.Web.Core.Authentication.AppVerificationFilter());
                options.Filters.Add(new Template1.Template2.Web.Core.Authentication.AppExceptionFilter());
                options.Filters.Add(new Template1.Template2.Web.Core.Authentication.AppResultFilter());
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Template1.Template2接口文档",
                    Description = "RESTful API for Template1.Template2",
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            //使用SqlSugar仓储
            builder.RegisterModule<Template2RepositoryModule>();
            //使用SyZero
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Template1.Template2.Web API V1");
